...
import { cardImg } from "../utils/server";
...
import nextIndicator from "../components/assets/icon/next-indicator.svg";
// style
...
const Home = () => {
  ...
  const aePressetsRes = useRef(null);
  // carousel
  const settings = {
    dots: true,
    arrows: false, // Prev va Next tugmalarini olib tashlash
    infinite: true,
    speed: 500,
    slidesToShow: 3,
    slidesToScroll: 1,
    customPaging: (i) => (
      <div className="custom-dot"></div> // Dot'larni o'zgartirish
    ),
    responsive: [
      {
        breakpoint: 768,
  ...
  return (
    <div className="darken">
      {/* home */}
      <main ref={homeRef} id="home" className="section-one">
      ...
      {/* about */}
      <div ref={aboutRef} id="about" className="section-two">
        <div className="container">
      ...
      <div
        ref={aePressetsRes}
        id="ae-pressets"
        className="ae-presets section-three"
      >
        <div className="container">
          <div className="pack">
            <div className="pressets-top-texts">
              <div className="lorem-ip">
                <span>LOREM IPSUM</span>
                <p>
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                  diam nonummy nibh euismod tincidun
                </p>
              </div>
              <h2>Exclusive IT Services</h2>
              <Link to={"/next"}>
                <img src={nextIndicator} alt="nextIndicator" />
              </Link>
            </div>
            <Slider {...settings} className="packs">
              {cardImg.map((cardE) => (
                <div key={cardE.id} className="pack-card">
                  <div className="pack-card-img">
                    <img
                      className="card-border"
                      src={cardE.cardBorder}
                      alt="cardBorder"
                    />
                    <img
                  ...
                  <div className="pack-card-text">
                    ...
                    <p>{cardE.description}</p>
                    <Link to={"/"}>{cardE.projectLink}</Link>
                  </div>
                </div>
              ))}
            </Slider>
